						...
						<div className='col-lg-3 col-md-5'>
							<div className='footer-widget widget_contact_info wow fadeInUp delay-0-6s'>
								...
								<ul>
									...
									<li>
										<i className='far fa-phone' /> <a href='callto:+923214862601'>+92 (321) 4862601</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div className='row'>
						...
						<div className='col-lg-6 text-lg-end'>
							<ul className='footer-bottom-nav'>
								<li>
									<a target='_blank' href='https://www.linkedin.com/in/misbah-kashif/'>
										LinkedIn
									</a>
								</li>
								
								{/* <li>
									<a target='_blank' href='https://github.com/HamzaAshfaq01'>
										Github
									</a>
								</li> */}
							</ul>
