        ...
        <div className="row align-items-center pb-25">
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="project-content wow fadeInRight delay-0-2s">
              ...
              <p>
                Four Seasons Bahawalpur: Premier dining, weddings, bakery in
                South Punjab, Pakistan. Enjoy Pakistani, continental, and
                Chinese cuisine.
              </p>
              <a
                target="_blank"
                className="details-btn"
                href="https://fourseasonspk.com/"
              >
                <i className="far fa-arrow-right" />
              </a>
            </div>
        ...
        <div className="row align-items-center pb-25">
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="project-content wow fadeInRight delay-0-2s">
              ...
              <p>
                IDENBRID INC. is a tech company specializing in app and web
                system development. Led by CEO Souga Nakamura and COO Aska
                Ikeda, the company aims to upgrade the future through
                technology. (Update the future in style.)
              </p>
              <a
                target="_blank"
                className="details-btn"
                href="https://idenbrid.jp/"
              >
                <i className="far fa-arrow-right" />
              </a>
            </div>
